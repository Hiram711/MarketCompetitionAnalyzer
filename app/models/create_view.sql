...
case
when a.price_type1='标准经济舱' and c.company_name='祥鹏航空' then 'economy'
when a.price_type1='优惠经济舱' and c.company_name='祥鹏航空' then 'member'
when a.price_type1='公务舱' and c.company_name='祥鹏航空' then 'luxury'
else price_type1
end as price_type1_alias
